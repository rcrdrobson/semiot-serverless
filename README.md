...
**sl-handler** use [ISC Lincense](https://en.wikipedia.org/wiki/ISC_license). Feel free to fork **semiot-serverless** on GitHub if you have any features that you want to add!
